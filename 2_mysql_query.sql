...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Mar 2022 pada 05.54
...
--
ALTER TABLE `tb_mahasiswa_nilai`
  ADD CONSTRAINT `mhs_id` FOREIGN KEY (`mhs_id`) REFERENCES `tb_mahasiswa` (`mhs_id`),
  ADD CONSTRAINT `mk_id` FOREIGN KEY (`mk_id`) REFERENCES `tb_matakuliah` (`mk_id`);
COMMIT;
